...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Book_Management</application>
    ...
    <classAccesses>
        <apexClass>PriceCalculation</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>PriceCalculationTest</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
        <editable>false</editable>
        <field>Book_Order__c.Quantity__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Book_Order__c.Total_Price__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Book__c.Quantity__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Book_Order__c-Order Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
